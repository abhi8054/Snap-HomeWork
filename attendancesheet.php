        ...
        <div class="col-md-5">
            ...
            <div class="mb-3 text-center">
                <button type="submit" onclick="getAttendance()" class="btn btn-info bg-transparent text-info"
                        style="text-align: center;padding: 10px 20px;border-radius: 20px"><h5> Take Attendance <i
...
<script>
    ...
    function getAttendance() {
        ...
        httprequest.open('GET', 'cascadedata.php?coursename=' + sub + '&semester=' + sem + '&option=table1', true);
        httprequest.send();
