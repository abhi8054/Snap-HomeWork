    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="images/ban22.jpg"  class="d-block w-100" style="height: calc(100vh - 81px)" alt="...">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="images/ban33.jpg" class="d-block w-100" style="height: calc(100vh - 81px)" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5 style="font-size: 50px; margin-bottom: 265px; color:yellow ;font-weight: bold">Value of education to future</h5>
                </div>
            </div>
            <div class="carousel-item">
                <img src="images/ban44.jpg" class="d-block w-100" style="height: calc(100vh - 81px)" alt="...">
                <div class="carousel-caption d-none d-md-block">
