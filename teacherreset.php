...
<div class="container-fluid">
    <h1 class="mt-5 mb-5 text-center text-info" id="h1" >Reset Password Form &nbsp;<i class="fas fa-key"></i></h1>
    <div class="row text-center justify-content-center">
        <div class="col-md-4 bg-transparent" id="forgot">
            <h3 class="pt-3 pb-4 text-info">Change Password</h3>
            <form action="teacherenter.php" method="post">
                <div class="mb-3">
                    <label for="exampleInputoldPassword1" class="form-label text-info" style="font-size:20px">Old Password</label>
                    <input type="password" class="form-control" required placeholder="Old Password" name="oldpass" id="exampleInputoldPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputnewPassword1" class="form-label text-info" style="font-size:20px">New Password</label>
                    <input type="password" class="form-control" required placeholder="New Password" name="newpass" id="exampleInputnewPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputconPassword1" class="form-label text-info" style="font-size:20px">Confirm Password</label>
