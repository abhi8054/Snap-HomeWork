	...
	<div class="about">
		<div class="container  py-md-3">
			<div class="w3-head-all mb-3 text-center">
		         <h5 class='mt-4 mb-4' style="font-size: 50px; color: #0d6efd;">About More</h5>
            </div>
			<div class="agile_about_grids row">
				...
				<div class="col-md-6 agile_about_grid_right">
					<p class=" text-justify" style="color: #fff"> A multi faculty institution, that aims to blend professional & vocational
