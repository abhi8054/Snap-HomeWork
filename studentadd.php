...
<div class="container">
    ...
    <div class="row justify-content-center">
        <h1 class="text-center mb-4 mt-4 text-warning class="bg-dark" "><strong>Add Student Details</strong></h1>
        <div class="col-md-5 text-warning bg-transparent">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <?php
                    ...
                    $sql="SELECT MAX(studentroll) AS max FROM student";
                ...
                ?>
                <label for="exampleInputnamme" class="form-label ">Roll No.</label>
                <input type="text" class="form-control  text-warning bg-transparent" readonly value="<?php echo $roll; ?>" name="rollno" id="exampleInputnamme">
            </div>

            <div class="mb-3">
                <label for="selectcountry" class="form-label">Select Semester</label>
                <select name="semester" class="form-select text-warning bg-transparent" aria-label="Default select example" id="selectcountry">
            ...
            <div class="mb-3">
                <button type="submit" class="btn btn-warning bg-transparent text-warning  " name="action" value="addstudent"
        ...
        <div class="col-md-5 text-warning">
            <div class="mb-3">
                ...
                <input type="text" class="form-control  text-warning bg-transparent" placeholder="Father Name" name="fathername" id="exampleInputnamme">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control  text-warning bg-transparent" placeholder="Guidance Mobile No." name="guidancemobile"
                       id="exampleInputmobile">
            </div>
            <div class="mb-3">
                <?php
                ...
                <input type="password" class="form-control  text-warning bg-transparent" value="<?php echo $password;?>" readonly placeholder="Password" name="password"
