...
<div class="container">
    <h1 class="text-center mt-4 mb-4 text-warning"><strong>View Notice Details</strong></h1>
                ...
                while ($res = mysqli_fetch_array($execute)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form onsubmit=" return confirm('Are you sure you want to delete ?')" action="noticeaction.php"
                                  method="post">
                                <input type="hidden" name="noticeid" value="<?php echo $res[0]; ?>">
                                <button type="submit" class="btn btn-light text-light bg-transparent" name="action" value="deletenotice"  style="text-align: center;padding: 10px 20px;border-radius: 20px"><i
