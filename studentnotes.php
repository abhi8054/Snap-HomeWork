...
<div class="container">
    ...
    ?>
    <h2 class="text-center mt-4 text-white mb-4"><strong> Course : <?php echo $row[0];?> || Semester : <?php echo $row[1].'th'; ?></strong></h2>
    <h2 class="text-center mt-4 text-white mb-4"><strong> My Notes Details</strong></h2>
...
<script>
    function getnotes(subject){
        ...
        httprequest.open('GET','studentcascade.php?subject='+subject+'&option=notes',true)
        httprequest.send()
