        ...
        <div class="col-md-6 text-center" id="form">
            ...
            <form action="adminaction.php" method="post">
                <div class="mb-3">
                    ...
                    <input style="color: #ffbf00 ;border: none; border-radius:10px;height:50px;font-weight:bold" type="text" class="form-control" required placeholder="Username" id="exampleInputtext"
                           name="username">
                </div>
                <div class="mb-3">
